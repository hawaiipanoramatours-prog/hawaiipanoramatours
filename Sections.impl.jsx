    ...
    >
      ...
      <div className="relative z-10 text-center text-white px-6 max-w-4xl mx-auto">
        <motion.div initial={{opacity:0,y:30}} animate={{opacity:1,y:0}} transition={{duration:.8}}>
          ...
          {/* ✅ UPDATED HERO HEADLINE (Option A) */}
          <h1 className="font-playfair tracking-tight leading-[0.95] mb-6">
            <span className="block text-white font-medium text-[clamp(44px,7vw,96px)]">
              {h.title[lang] || h.title.de}
            </span>
            <span className="block mt-1 text-turquoise font-semibold text-[clamp(32px,6vw,78px)]">
    ...
    <section id="services" className="py-20 bg-white">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="font-poppins text-xl text-gray-600 max-w-2xl mx-auto">
            {lang==='en'?'Choose the service that fits you best':'Wählen Sie den Service, der perfekt zu Ihnen passt'}
          </p>
        </motion.div>
          ...
          {items.map((s,i)=>{
            ...
            return (
              ...
              >
                ...
                <div className="mb-6">
                  <span className="font-playfair text-3xl font-bold text-turquoise">{s.price}</span>
                </div>
                <ul className="space-y-2 mb-8">
                  {s.features.map((f,idx)=> (
                    <li key={idx} className="flex items-center font-poppins text-gray-600">
    ...
    <section className="py-20 bg-gradient-to-b from-sand/20 to-light-blue/10">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="font-poppins text-xl text-gray-600 max-w-2xl mx-auto">
            {lang==='en'?'Comprehensive services for a perfect trip':'Umfassende Services für Ihr perfektes Hawaii-Erlebnis'}
          </p>
        </motion.div>
      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="mt-4">
              <a href={content.brand.social.calendly} target="_blank" rel="noreferrer" className="bg-turquoise text-white px-4 py-2 rounded-lg font-poppins text-sm">
                Termin buchen
              </a>
            </div>
          </div>
